                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header border border-bottom-0">Form Login</div>
                                    <div class="card-body">
                                        <div class="col-sm-8 offset-sm-2">
                                            <div class="card p-3">
                                                <form id="formAuthentication" action="auth-register.php" class="mb-3" method="POST">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="mb-3">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <div class="mb-3 form-password-toggle">
                                                                ...
                                                                <!-- notes regist from admin -->
                                                                <input type="hidden" name="page_register" value="pages_register">
                                                                <!--  -->
